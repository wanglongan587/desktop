...
- [git](src/git/README.md) exposes typed repository, worktree, branch, status, add, commit, and configuration use cases.
...
Errors remain separated into domain validation, process execution, and output parsing categories before being wrapped as `GitlancerError`.
