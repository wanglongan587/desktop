...
export const translationResources = {
  "zh-CN": {
    ...
    "spec.emptyHint": "默认识别 openspec/changes、docs/superpowers/specs 与 docs/specs，也可在 .ora/specs.toml 中声明自己的目录。",
    "spec.cardLabel": "Spec",
  ...
  "en-US": {
    ...
    "spec.emptyHint": "openspec/changes, docs/superpowers/specs, and docs/specs are recognized by default. Declare your own layout in .ora/specs.toml.",
    "spec.cardLabel": "Spec",
