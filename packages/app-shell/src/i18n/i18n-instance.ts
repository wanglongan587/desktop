...
export const translationResources = {
  "zh-CN": {
    ...
    "errors.multiple_clients_unsupported": "当前后端仅支持一个活动应用页面。",
    ...
    "appEvents.multipleClients.description": "当前后端只支持一个活动应用页面。关闭另一页面后，再手动重试。",
    "appEvents.multipleClients.retry": "重新检查",
  ...
  "en-US": {
    ...
    "errors.multiple_clients_unsupported": "This backend supports only one active application page.",
    ...
    "appEvents.multipleClients.description": "This backend supports one active application page. Close the other page, then retry manually.",
    "appEvents.multipleClients.retry": "Check again",
