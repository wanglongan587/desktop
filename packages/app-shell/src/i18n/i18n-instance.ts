...
export const translationResources = {
  "zh-CN": {
    ...
    "errors.project_occupied": "该项目正在被其他工作上下文使用。",
    "errors.project_work_context_not_found": "未找到项目工作上下文。",
    ...
    "workflowRun.field.totals": "用量",
    "workflowRun.field.duration": "耗时",
    "workflowRun.field.startedAt": "开始",
    "workflowRun.field.finishedAt": "结束",
    "workflowRun.field.tokens": "Tokens",
    ...
    "workflowRun.totalsTokens": "{{count}} tokens",
    "workflowRun.totalsDuration": "{{ms}} ms",
    ...
    "workflowRun.inspector.nodeSuffixEditable": "{{type}} · 仅本次",
    "workflowRun.inspector.runOnlyHint": "修改只作用于本次运行的快照，不会写回工作流定义。启动后锁定。",
    ...
    "workflowRun.updateFailed": "更新运行配置失败。",
    ...
    "settings.workflow.library": "工作流",
    "settings.workflow.workflowCount": "{{count}} 个工作流",
    ...
    "settings.workflow.canvasHint": "滚轮缩放 · 拖拽移动 · 节点自动对齐网格",
    ...
    "settings.workflow.mockVersionHistory": "Mock",
    ...
    "settings.workflow.renameError": "重命名工作流失败。",
    "settings.workflow.deleteError": "删除工作流失败。",
    ...
    "settings.workflow.closePreview": "关闭测试结果",
    "settings.workflow.running": "正在模拟工作流…",
    ...
    "settings.skills.marketplaceConnectionFailed": "无法打开 SkillHub 或读取下载状态，请重试。",
    ...
    "settings.skills.marketplaceDownloadFailed": "下载失败，请在 SkillHub 中重试。",
    ...
    "settings.skills.huaweiViewReadiness": "打开内网 Skill Market",
    "settings.skills.huaweiDialogTitle": "Huawei Agent Center",
    "settings.skills.huaweiDialogDescription": "Ora 已连接真实 Agent Center 地址并隔离浏览器登录态；剩余工作集中在华为内网的 SSO 与下载联调。",
    "settings.skills.huaweiPlainTextGuide": "当前状态\nWebView2 顶层加载和独立登录会话目录已经完成。企业 SSO、登录弹窗、域名白名单以及 Skill ZIP 下载仍需在华为内网联调。\n\n公开等效测试\nGitHub Marketplace 禁止第三方 iframe，但可以作为顶层页面打开，并带有真实登录入口。点击下方测试按钮可验证同一套独立 WebView、登录跳转和域名白名单链路。测试环境与华为登录态完全隔离。\n\n后续接入工作\n1. 确认 SSO 跳转、扫码/MFA 和企业证书行为。\n2. 触发一次真实 ZIP 下载并确认下载域名。\n3. 验证关闭窗口和重启 Ora 后的登录态复用。\n4. 将首轮 *.huawei.com 范围收敛为精确域名白名单。\n\nWindows 内网测试指引\n1. 连接华为 VPN/内网，确认企业 DNS、系统代理和根证书可用。\n2. 启动 Agent Center，完成登录并确认市场列表和详情页可访问。\n3. 下载一个测试 Skill，核对 Ora 下载提示、文件保存和后续导入。",
    "settings.skills.huaweiCompatibilityTestLaunch": "打开 GitHub 等效测试",
    "settings.skills.huaweiCompatibilityTestOpening": "正在打开测试…",
    "settings.skills.huaweiCompatibilityTestFailed": "未能打开 GitHub 等效测试，请检查公网连接。",
    "settings.skills.huaweiConnectionFailed": "未能打开 Agent Center。请先检查华为内网、DNS、代理和证书环境。",
    "settings.skills.huaweiDesktopRequired": "真实 Agent Center 入口仅可从 Ora Desktop 启动。",
    "settings.skills.huaweiClose": "稍后测试",
    "settings.skills.huaweiLaunch": "在内网启动 Agent Center",
    ...
    "delete.workflowRunDescription": "将删除此次工作流运行。若仍在进行中，会先取消再删除；同项目下其他运行不受影响。",
    "delete.deleting": "删除中…",
    ...
    "diff.loading": "正在加载变更…",
    "diff.loadingDetail": "正在读取任务工作树和审查讨论。",
    "diff.loadError": "无法加载变更",
    "diff.requestFailed": "任务 Diff 请求失败。",
    "diff.retry": "重试",
    "diff.changedFiles": "{{count}} 个变更文件",
    "diff.scope": "变更范围",
    "diff.scopeBranch": "分支",
    ...
    "diff.discussion": "审查讨论",
    "diff.resolve": "解决",
    "diff.reopen": "重新打开",
    "diff.reply": "回复",
    "diff.replyPlaceholder": "回复…",
    "diff.commentOn": "评论 {{path}}:{{line}}",
    "diff.commentPlaceholder": "留下审查评论…",
    "diff.commentLabel": "审查评论",
    "diff.addComment": "添加评论",
    "diff.reviewFailed": "审查请求失败。",
    "chat.new": "新建对话",
    "chat.newThread": "新建对话",
    ...
    "dashboard.close": "关闭侧边面板",
    "dashboard.resize": "拖拽调整侧边面板宽度",
    "dashboard.title": "侧边面板",
    "dashboard.tab.review": "审阅",
    "dashboard.tab.terminal": "终端",
    ...
    "dashboard.loadingFrame": "正在加载 Dashboard…",
  },
  "en-US": {
    ...
    "errors.project_occupied": "The project is owned by another active work context.",
    "errors.project_work_context_not_found": "The project work context was not found.",
    ...
    "workflowRun.field.totals": "Usage",
    "workflowRun.field.duration": "Duration",
    ...
    "workflowRun.theater.nodeId": "Node",
    ...
    "workflowRun.inspector.nodeSuffixEditable": "{{type}} · this run only",
    "workflowRun.inspector.runOnlyHint": "Edits apply only to this run's frozen snapshot, not the library definition. Locked after start.",
    ...
    "workflowRun.updateFailed": "Failed to update the run configuration.",
    ...
    "settings.workflow.canvasHint": "Scroll to zoom · Drag to pan · Nodes snap to grid",
    ...
    "settings.workflow.renameError": "Failed to rename the workflow.",
    "settings.workflow.deleteError": "Failed to delete the workflow.",
    ...
    "settings.skills.marketplaceConnectionFailed": "Unable to open SkillHub or read download status. Try again.",
    ...
    "settings.skills.marketplaceDownloadFailed": "Download failed. Try again in SkillHub.",
    ...
    "settings.skills.huaweiViewReadiness": "Open internal Skill Market",
    "settings.skills.huaweiDialogTitle": "Huawei Agent Center",
    "settings.skills.huaweiDialogDescription": "Ora is wired to the live Agent Center endpoint with an isolated browser session. The remaining work is internal SSO and download validation.",
    "settings.skills.huaweiPlainTextGuide": "Current status\nTop-level WebView2 loading and an isolated login-session directory are ready. Enterprise SSO, login popups, the domain allowlist, and Skill ZIP downloads still require validation on Huawei's internal network.\n\nPublic compatibility test\nGitHub Marketplace blocks third-party iframes but can be opened as a top-level page and provides a real sign-in entry point. Use the test button below to validate the same isolated WebView, login navigation, and host allowlist path. Its session is fully isolated from Huawei.\n\nRemaining integration work\n1. Confirm SSO redirects, QR/MFA, and enterprise certificate behavior.\n2. Trigger one live ZIP download and record its download host.\n3. Verify login reuse after closing the window and restarting Ora.\n4. Reduce the initial *.huawei.com boundary to an exact host allowlist.\n\nWindows internal test guide\n1. Connect to Huawei VPN/internal networking and verify DNS, system proxy, and root certificates.\n2. Launch Agent Center, complete sign-in, and open marketplace list and detail pages.\n3. Download a test skill and verify Ora's progress, saved archive, and import handoff.",
    "settings.skills.huaweiCompatibilityTestLaunch": "Open GitHub compatibility test",
    "settings.skills.huaweiCompatibilityTestOpening": "Opening test...",
    "settings.skills.huaweiCompatibilityTestFailed": "The GitHub compatibility test could not be opened. Check the public network connection.",
    "settings.skills.huaweiConnectionFailed": "Agent Center could not be opened. Check Huawei networking, DNS, proxy, and certificates.",
    "settings.skills.huaweiDesktopRequired": "The live Agent Center endpoint can only be launched from Ora Desktop.",
    "settings.skills.huaweiClose": "Test later",
    "settings.skills.huaweiLaunch": "Launch Agent Center on internal network",
    ...
    "delete.workflowRunDescription": "This workflow run will be removed. If it is still active it is cancelled first; other runs in the same project are unaffected.",
    ...
    "diff.loadingDetail": "Reading the task worktree and review discussions.",
    "diff.loadError": "Unable to load changes",
    "diff.requestFailed": "The task diff request failed.",
    "diff.retry": "Retry",
    "diff.changedFiles": "{{count}} changed files",
    ...
    "diff.discussion": "Review discussion",
    "diff.resolve": "Resolve",
    "diff.reopen": "Reopen",
    "diff.reply": "Reply",
    "diff.replyPlaceholder": "Reply...",
    "diff.commentOn": "Comment on {{path}}:{{line}}",
    "diff.commentPlaceholder": "Leave a review comment...",
    "diff.commentLabel": "Review comment",
    "diff.addComment": "Add comment",
    "diff.reviewFailed": "The review request failed.",
    "chat.new": "New chat",
    ...
    "dashboard.close": "Close side panel",
    "dashboard.resize": "Drag to resize the side panel",
    "dashboard.title": "Side panel",
    "dashboard.tab.review": "Review",
    "dashboard.tab.terminal": "Terminal",
    "dashboard.tab.dashboard": "Dashboard",
    ...
    "dashboard.loadingFrame": "Loading Dashboard…",
  },
} as const;
