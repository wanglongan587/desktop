...
export const translationResources = {
  "zh-CN": {
    ...
    "errors.spec_workspace_unavailable": "当前工作区不可用，无法读取 spec。",
    "errors.spec_not_found": "未找到该 spec 文档。",
    ...
    "spec.title": "Spec",
    "spec.panel": "Spec 面板",
    "spec.open": "查看 Spec 文档",
    "spec.close": "收起 Spec 面板",
    "spec.resize": "调整 Spec 面板宽度；双击恢复默认宽度",
    "spec.loading": "正在读取 spec…",
    "spec.pickProject": "请先选择一个项目，再查看 spec。",
    "spec.selectHint": "从左侧选择一篇 spec 查看内容。",
    "spec.empty": "当前工作区没有发现 spec 文档。",
    "spec.emptyHint": "默认识别根目录 SPEC.md、openspec/changes、docs/superpowers/specs 与 docs/specs，也可在 .ora/specs.toml 中声明自己的目录。",
    "spec.cardLabel": "Spec",
    "spec.openCard": "打开 Spec：{{name}}",
  ...
  "en-US": {
    ...
    "errors.spec_workspace_unavailable": "The workspace is unavailable, so specs cannot be read.",
    "errors.spec_not_found": "The spec document was not found.",
    ...
    "spec.open": "View specs",
    "spec.close": "Collapse the spec panel",
    "spec.resize": "Resize the spec panel; double-click to reset its width",
    "spec.loading": "Loading specs…",
    "spec.pickProject": "Pick a project to browse its specs.",
    "spec.selectHint": "Choose a spec on the left to read it.",
    "spec.empty": "No spec documents found in this workspace.",
    "spec.emptyHint": "Root SPEC.md, openspec/changes, docs/superpowers/specs, and docs/specs are recognized by default. Declare your own layout in .ora/specs.toml.",
    "spec.cardLabel": "Spec",
    "spec.openCard": "Open Spec: {{name}}",
