...
export const translationResources = {
  "zh-CN": {
    ...
    "errors.spec_source_invalid": "所选 Spec 目录无效或不在当前工作区内。",
    ...
    "specs.sourcesDescription": "这些设置作用于项目根目录及其所有 worktree。",
  ...
  "en-US": {
    ...
    "errors.spec_source_invalid": "The selected Spec directory is invalid or outside the current workspace.",
    ...
    "specs.sourcesDescription": "These settings apply to the project root and every worktree.",
