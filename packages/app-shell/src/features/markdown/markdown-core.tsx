...
/** Remark plugins shared by every Markdown surface so tables and task lists render alike. */
export const markdownRemarkPlugins = [remarkGfm];

/**
 * The element mapping shared by the chat stream and the static document reader.
 *
 * Streaming surfaces layer their reveal `span` on top of this object rather than
 * forking it, so prose typography can never drift between the two readers.
 */
