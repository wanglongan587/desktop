...
/**
 * Claude's radial "starburst" mark, taken from claude.ai's favicon. This is the
 * product mark for Claude Code, as opposed to Anthropic's corporate "A" wordmark
 * that `provider-logos` uses for the model provider.
 */
export function ClaudeMark(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 248 248" fill="currentColor" aria-hidden="true" {...props}>
